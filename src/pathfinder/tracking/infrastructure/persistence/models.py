...
class ApplicationModel(Base, UUIDMixin, TimestampMixin):
    ...
    cover_letter_id: Mapped[UUID | None] = mapped_column(PGUUID, ForeignKey("cover_letters.id"), nullable=True)
    ...
    def to_domain(self) -> Application:
        return Application(
            ...
            resume_id=self.resume_id, cover_letter_id=self.cover_letter_id,
    ...
    def from_domain(cls, app: Application) -> "ApplicationModel":
        return cls(
            ...
            resume_id=app.resume_id, cover_letter_id=app.cover_letter_id,
